                    ...
                    <table class="w-full border-collapse">
                      ...
                      >
                        ...
                        <c:out value="${project.projectStatus}" />
                                ...
                                <td class="py-4 px-6 text-sm text-gray-600"><c:out value="${project.startDate}" /></td>
                                <td class="py-4 px-6 text-sm text-gray-600"><c:out value="${project.endDate}" /></td>
                                <td class="py-4 px-6 text-sm text-gray-800"><c:out value="${fn:length(project.tasks)}" /></td>
                                <td class="py-4 px-6 text-sm text-gray-800">20</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
